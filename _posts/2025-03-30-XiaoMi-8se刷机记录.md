...
![悲惨世界](2025-03-30-XiaoMi-8se/breakdown.jpg "悲")
...
![这是短接点](2025-03-30-XiaoMi-8se/Xiaomi-Mi-8-SE-Test-Point-For-Flashing-Mi-8-SE-EDL-9008-Mode.png "testpoint for sirius")

手机关机后,保持测试点短接,用数据线连接电脑,此时电脑应该会有声音响应,进入设备管理器查看端口

![这是9008端口](2025-03-30-XiaoMi-8se/9008com.png "9008com")
...
![这是9008端口](2025-03-30-XiaoMi-8se/coolpak_gaotongtoolkit_mouzei.png "某贼,刷机界佬")
...
3. 刷入选择xml批量刷入,随后弹出的窗口里选择"rowprogram.xml"文件(在官方ROM解压包中images文件夹中)
   ...
   ![rowprogram.xml](2025-03-30-XiaoMi-8se/rowprogram.png "rowprogram.xml")在跳出第二个窗口里选择"patch.xml"文件(可能有多个,都选上)

   ![patch](2025-03-30-XiaoMi-8se/patch.png "patch.xml")
...
![BLTOOL](2025-03-30-XiaoMi-8se/BLTool.png "伟大无需多言")
...
![logo](2025-03-30-XiaoMi-8se/twrp_logo.jpg)![menu](2025-03-30-XiaoMi-8se/twrp_menu.jpg)
...
![google pixel](2025-03-30-XiaoMi-8se/google!.jpg)
